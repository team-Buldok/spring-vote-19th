package buldog.vote.configuration;

import buldog.vote.jwt.cookie.CookieUtil;
import buldog.vote.jwt.filter.CustomLogoutFilter;
import buldog.vote.jwt.filter.JwtFilter;
import buldog.vote.jwt.filter.LoginFilter;
import buldog.vote.jwt.service.RefreshTokenService;
import buldog.vote.jwt.util.JwtUtil;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((auth) -> auth
                ...
                .requestMatchers("/login", "/", "/join", "/reissue").permitAll()  // root 경로 접근 허용 (추후 "**" 제거해야 함. 개발시 편의를 위해 설정)
